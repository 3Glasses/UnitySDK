...
{
    public static class ThreeGlassesConst
    {
        public const string ResourcesPath = "ThreeGlasses/";
        public const string ImageResourcesPath = ResourcesPath + "Image/";
        public const string FixShaderPath = ResourcesPath + "Shader/FixRenderTargetUV";
        public const string MergeShaderPath = ResourcesPath + "Shader/FixRenderTargetUV";
